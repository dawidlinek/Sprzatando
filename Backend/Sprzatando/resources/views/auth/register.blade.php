                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group pb-0">
                            <div class="b-col col-10 mx-auto">
                                ...
                                <input name="name" :value="{{ old('name') }}" required autofocus autocomplete="name" type="text" class="form-control mb-4" id="FormControlInput1" placeholder="Nazwa użytkownika" />
                            </div>
                            <div class="b-col col-10 mx-auto">
