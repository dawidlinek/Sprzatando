                            ...
                            <div class="col-lg-5">
                                <div class="card-body d-flex flex-column align-items-start justify-content-between">
                                    ...
                                    <form class="w-100">
                                        ...
                                        <input type="text"  id='LocalizationAutocomplete' class="form-control mb-4" />
                            ...
                            <div class="col-lg-5 d-flex align-items-center justify-content-center">
                                <div class="card-body d-flex flex-column align-items-center justify-content-around h-100">
                                    <form class="w-100" method='POST' action='{{route('announcement.store')}}'>
                                        ...
                                        <input type="date" class="form-control mt-1 mb-5" />
                                        ...
                                        <select class="form-select mb-5 mt-1">
                                        ...
                                        <label for="FormControlInput1 col-offset" class="mb-3">Dodaj zdjęcia:</label> <br />
                                            ...
                                            <div class="custom-file d-flex justify-content-between align-items-start w-100 mb-5" style="height: 15vh;">
                                                <div class="w-25">
                                                    <input class="form-control mb-3 custom-file-input" accept="image/png, image/jpeg" type="file" id="formFileDisabled1"/>
                                    ...
                                    <button type='submit' class="btn btn-primary w-100 mt-5 mb-1">Dodaj</a>
                                    </form>
                                </div>
                            </div>
                        </div>
