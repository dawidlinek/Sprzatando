                    ...
                    <div class="row w-100 d-flex flex-lg-row flex-md-column justify-content-around">
                        ...
                        <div class="col-xl-5">
                            <div class="d-flex flex-column align-items-start justify-content-between">
                                ...
                                <input type="text" name='localization' required value="{{$announcement->localization}}" id='LocalizationAutocomplete' class="form-control mb-4" />
                        ...
                        <div class="col-xl-5">
                            <div class="d-flex h-100 flex-column align-items-start justify-content-between">
                                ...
                                <div class="w-100">
                                    ...
                                    <input type="text" name="categories" class="d-none" id="categoryServerSee" value="{{implode(',',$announcement->categories()->pluck('id')->toArray())}}" />
                            ...
                            <div class="w-100" style="margin-bottom: 2.8rem;">
                                <button type='submit' form='update' class="btn btn-primary w-100 mt-3 text-white">Dodaj</a>
                            </div>
                        </div>
                    </div>
                {{-- </form> --}}
