      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
          <ul class="navbar-nav mb-2 mb-lg-0">
            ...
            <li class="nav-item">
              <a class="nav-link btn-lg" aria-current="page" href="<?php echo e(url('/dashboard')); ?>">Panel</a>
            </li>
            ...
            <?php else: ?>
            <li class="nav-item">
              <a class="nav-link btn-lg" aria-current="page" href="<?php echo e(route('login')); ?>">Zaloguj się!</a>
            </li>
            <li class="nav-item">
              <a class="nav-link btn-lg" aria-current="page" href="<?php echo e(route('register')); ?>">Rejestracja</a>
            </li>
            <?php endif; ?>
          </ul>
        </div>
...
</html><?php /**PATH C:\Filip\websites\Sprzatando\Backend\Sprzatando\resources\views/welcome.blade.php ENDPATH**/ ?>