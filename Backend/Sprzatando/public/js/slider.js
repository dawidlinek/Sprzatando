...
let images = [
    "url('/img/login/undraw/undraw_awesome_rlvy-min.png')",
    "url('/img/login/undraw/undraw_pending_approval_xuu9-min.png')",
    "url('/img/login/undraw/undraw_Resume_folder_re_e0bi-min.png')"
]
let descriptions =[
