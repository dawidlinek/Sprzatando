    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                ...
                <div class="card mt-5 p-3 mx-auto">


                    <div class="img-fluid mx-auto">
                        <svg style="max-height: 50vh; max-width: 80vw;" id="6b5bbc3a-7ba8-40c4-8b79-fdc85beb38a1" data-name="Layer 1"
                            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                            width="1032.24" height="832.63" viewBox="0 0 1032.24 832.63">
                            <defs>
                                <linearGradient id="fb7ae7e0-1793-4d3b-a6c6-7b51ed07a232" x1="86.9" y1="457.32"
                                    x2="402.8" y2="457.32" gradientUnits="userSpaceOnUse">
                    ...
                    <div class="card-body">
                        <h2 class="text-center text-primary p-3 m-4">Błąd połączenia z internetem</h2>
                        <h3 class="text-center p-2">Przykro nam 😥</h3>
                    </div>
                </div>
            </div>
        </div>
